...
class PokerTest(unittest.TestCase):
    ...
    def test_two_hands(self):
        hand1 = '4S 5S 7H 8D KC'.split()
        hand2 = '2S 3S 4H 5D AC'.split()
        self.assertEqual([hand2], poker([hand1, hand2]))
    ...
    def test_two_pair2(self):
        pairOfJ = '4S JH 6S 2D JH'.split()
        pairOfT = '2S TH TS 4D JH'.split()
        self.assertEqual([pairOfJ], poker([pairOfJ, pairOfT]))
    ...
    def test_double_pair_vs_straight(self):
        doublePair2and8 = '2S 8H 2S 8D JH'.split()
        straight = 'AS 2H 3S 4D 5H'.split()
        self.assertEqual([straight], poker([doublePair2and8, straight]))
