...
class PythagoreanTripletTest(unittest.TestCase):
    ...
    def test_triplet3(self):
        ans = {(29, 420, 421), (341, 420, 541), (420, 851, 949),
    ...
    def test_is_coprime(self):
        self.assertEqual(True, is_coprime(3, 4))
        self.assertEqual(False, is_coprime(2, 4))
        self.assertEqual(False, is_coprime(99, 121))
        self.assertEqual(True, is_coprime(1001, 1002))
